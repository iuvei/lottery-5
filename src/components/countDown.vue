<template>
  <div>
    <span v-if="msTime.show">
      ...
      <span v-if="msTime.day > 0"><span>{{msTime.day}}</span> <span>{{dayTxt}}</span></span>
      <span>{{msTime.hour}}</span> <span>{{hourTxt}}</span>
      <span>{{msTime.minutes}}</span> <span>{{minutesTxt}}</span>
      <span>{{msTime.seconds}}</span> <span>{{secondsTxt}}</span>
    </span>
